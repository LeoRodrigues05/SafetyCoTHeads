...
Training data is produced by scripts/training/prepare_harmthoughts_training_data.py.
...
Multi-GPU (DDP):
    torchrun --nproc_per_node=N scripts/training/train_pathway_judge.py \
        --base-model Qwen/Qwen3-14B \
        --training-data data/pathway_judge_train.jsonl \
        --out-dir runs/pathway_judge_14b_lora

Single GPU:
    python scripts/training/train_pathway_judge.py \
        --base-model Qwen/Qwen3-14B \
        --training-data data/pathway_judge_train.jsonl \
        --out-dir runs/pathway_judge_14b_lora
...
def do_train(args: argparse.Namespace) -> None:
    ...
    if trainer.is_world_process_zero():
        ...
        log.info("To merge: python scripts/training/train_pathway_judge.py --merge-only "
