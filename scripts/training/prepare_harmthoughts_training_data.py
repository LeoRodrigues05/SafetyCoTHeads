...
Usage:
    ...
    python scripts/training/prepare_harmthoughts_training_data.py --print-annotations

    # Dry-run (sample 50 traces, print stats, do not write files):
    python scripts/training/prepare_harmthoughts_training_data.py --dry-run

    # Full run (writes train + test JSONL):
    python scripts/training/prepare_harmthoughts_training_data.py \
