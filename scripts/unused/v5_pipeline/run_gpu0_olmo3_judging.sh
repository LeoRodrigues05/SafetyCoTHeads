...
#   bash scripts/unused/v5_pipeline/run_gpu0_olmo3_judging.sh
# =============================================================================
set -euo pipefail
cd "$(dirname "$0")/../../.."
...
echo "  source .venv/bin/activate && python -m scripts.unused.v5_reports.make_v5_metrics_status_report"
