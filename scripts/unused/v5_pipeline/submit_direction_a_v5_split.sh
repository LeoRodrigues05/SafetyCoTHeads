...
#
# Usage:
#   bash scripts/unused/v5_pipeline/submit_direction_a_v5_split.sh qwen3_8b qwen3_4b_thinking
#
# Optional environment:
#   TASKS_PER_WORKER=16 MAX_ARRAY_CONCURRENCY=16 bash scripts/unused/v5_pipeline/submit_direction_a_v5_split.sh ...
...
for model_key in "$@"; do
    ...
    job_id="$(sbatch --parsable \
        ...
        scripts/unused/v5_pipeline/sbatch/direction_a_v5_split_driver.sbatch)"
