...
#   bash scripts/unused/v5_pipeline/run_olmo3_pipeline.sh
# =============================================================================
set -euo pipefail
cd "$(dirname "$0")/../../.."
...
if gen_done olmo3_7b_think; then
    ...
    bash scripts/unused/v5_pipeline/run_local_pipeline.sh olmo3_7b_think gen
fi
...
if discover_done olmo3_7b_base; then
    ...
    bash scripts/unused/v5_pipeline/run_local_pipeline.sh olmo3_7b_base discover
fi
...
if gen_done olmo3_7b_base; then
    ...
    bash scripts/unused/v5_pipeline/run_local_pipeline.sh olmo3_7b_base gen
fi
...
if gen_done olmo3_7b_base_own; then
    ...
    bash scripts/unused/v5_pipeline/run_local_pipeline.sh olmo3_7b_base_own gen
fi
...
bash scripts/unused/v5_pipeline/run_local_pipeline.sh olmo3_7b_think judge

banner "[6/7] olmo3_7b_base — judge"
bash scripts/unused/v5_pipeline/run_local_pipeline.sh olmo3_7b_base judge

banner "[7/7] olmo3_7b_base_own — judge"
bash scripts/unused/v5_pipeline/run_local_pipeline.sh olmo3_7b_base_own judge
...
echo "  python -m scripts.unused.v5_reports.make_v5_metrics_status_report"
