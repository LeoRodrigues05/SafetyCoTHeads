...
#   bash scripts/unused/v5_pipeline/setup_vm.sh
#
...
for mk in olmo3_7b_think olmo3_7b_base; do
    ...
    python -m scripts.generation.run_generation \
...
echo " Next:  bash scripts/unused/v5_pipeline/run_local_pipeline.sh olmo3_7b_think all"
echo " (see scripts/unused/v5_pipeline/run_local_pipeline.sh for staged / parallel runs)"
echo "=============================================================="
