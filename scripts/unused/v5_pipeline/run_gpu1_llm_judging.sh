...
#   bash scripts/unused/v5_pipeline/run_gpu1_llm_judging.sh
# =============================================================================
set -euo pipefail
cd "$(dirname "$0")/../../.."
...
bash scripts/unused/v5_pipeline/run_local_pipeline.sh qwen3_8b judge

banner "[2/2] llama31_8b_control — judge (full: 10 conditions × 2 datasets, all passes)"
bash scripts/unused/v5_pipeline/run_local_pipeline.sh llama31_8b_control judge
