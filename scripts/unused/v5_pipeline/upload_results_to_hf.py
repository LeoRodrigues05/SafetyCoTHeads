...
Usage:
    ...
    python scripts/unused/v5_pipeline/upload_results_to_hf.py --repo-id LeoRodrigues05/safety-cot-interventions-v5

    # Make it public (or gated) only after reviewing the harmful-content warning:
    python scripts/unused/v5_pipeline/upload_results_to_hf.py --repo-id <id> --public
...
Notes:
    ...
    * The dataset card (scripts/unused/v5_pipeline/hf_dataset_card.md) is uploaded as README.md.
"""
