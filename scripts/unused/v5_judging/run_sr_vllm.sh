...
#
# Wraps scripts/unused/v5_judging/run_v5_safety_reasoning.py --backend vllm with the environment
...
#   CUDA_VISIBLE_DEVICES=0 bash scripts/unused/v5_judging/run_sr_vllm.sh --num-shards 2 --shard-id 0
# =============================================================================
set -euo pipefail
cd "$(dirname "$0")/../../.."
...
exec python scripts/unused/v5_judging/run_v5_safety_reasoning.py --backend vllm "$@"
