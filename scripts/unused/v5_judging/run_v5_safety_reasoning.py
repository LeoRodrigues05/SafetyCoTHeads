...
Usage:
    python -m scripts.unused.v5_judging.run_v5_safety_reasoning --dry-run
    python -m scripts.unused.v5_judging.run_v5_safety_reasoning
    python -m scripts.unused.v5_judging.run_v5_safety_reasoning --models qwen3_8b --conditions baseline --datasets jbb
    # GPU 0 shard:
    CUDA_VISIBLE_DEVICES=0 python -m scripts.unused.v5_judging.run_v5_safety_reasoning --num-shards 2 --shard-id 0
    # GPU 1 shard:
    CUDA_VISIBLE_DEVICES=1 python -m scripts.unused.v5_judging.run_v5_safety_reasoning --num-shards 2 --shard-id 1
"""
