...
Usage:
    python -m scripts.unused.v5_judging.reaggregate_v5_summaries            # rewrite in place
    python -m scripts.unused.v5_judging.reaggregate_v5_summaries --dry-run  # report only
"""
