...
Usage:
  python scripts/judging/route_v6_scratch.py --stage safety-reasoning            # route live
  python scripts/judging/route_v6_scratch.py --stage safety-reasoning --dry-run  # report only
  python scripts/judging/route_v6_scratch.py --stage safety-reasoning \
