...
Usage:
    python -m scripts.discovery.run_attribution --config configs/experiments/exp01_reproduce_ships_sahara/01-ships-discovery.yaml
    python -m scripts.discovery.run_attribution --config configs/experiments/exp01_reproduce_ships_sahara/02-sahara-discovery.yaml [--dry-run]
"""
...
# allow `python scripts/discovery/run_attribution.py` without -m
