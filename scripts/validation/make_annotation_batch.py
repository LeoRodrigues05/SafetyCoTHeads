...
prefer-unsafe sampler in scripts/unused/v5_reports/make_side_by_side_report.py.
...
Usage:
    python -m scripts.validation.make_annotation_batch --n-safety 80 --n-cot 40 --seed 0
"""
...
def main() -> int:
    ...
    print(f"\nNext: python -m scripts.validation.annotate_server --batch {out}")
    return 0
