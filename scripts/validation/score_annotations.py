...
Usage:
    python -m scripts.validation.score_annotations --batch data/annotations/batch_v5_001
"""
...
# --------------------------------------------------------------------------- #
# Cohen's kappa / F1 — copied VERBATIM from scripts/training/eval_pathway_judge.py:106-129
