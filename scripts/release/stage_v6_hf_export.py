...
invocation of scripts/unused/v5_pipeline/upload_results_to_hf.py against this staged directory.
"""
...
"""
    ...
    C.write_json(stage / "STAGING_INFO.json", {
        ...
        "published": False,
        "publish_requires": "explicit human approval + scripts/unused/v5_pipeline/upload_results_to_hf.py",
