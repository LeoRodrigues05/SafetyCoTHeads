...
def main():
    ...
    manifest = {
        ...
        "exact_commands": {
            "audit": "bash scripts/unused/v6_orchestration/run_v6_two_b200.sh audit",
            "parse": "bash scripts/unused/v6_orchestration/run_v6_two_b200.sh parse",
            "answer": "bash scripts/unused/v6_orchestration/run_v6_two_b200.sh answer",
            "monitor": "bash scripts/unused/v6_orchestration/run_v6_two_b200.sh monitor",
            "pathway": "bash scripts/unused/v6_orchestration/run_v6_two_b200.sh pathway",
            "safety_reasoning": "bash scripts/unused/v6_orchestration/run_v6_two_b200.sh safety-reasoning",
            "aggregate": "bash scripts/unused/v6_orchestration/run_v6_two_b200.sh aggregate --n-boot 10000",
            "validation": "bash scripts/unused/v6_orchestration/run_v6_two_b200.sh validation",
            "all": "bash scripts/unused/v6_orchestration/run_v6_two_b200.sh all",
        },
        "cell_counts": {
